...
/**
	A Rectangular shaped boat that can be positioned anywhere on the screen.
*/

public class RectBoats implements Animatable, Runnable
{
   private int x;
   private int y;
   private int r;
   ...
   */
   public RectBoats(int xPos, int yPos)
   {
      x = xPos;
      y = yPos;
